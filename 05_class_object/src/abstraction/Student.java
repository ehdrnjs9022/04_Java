...
// class = 객체의 멤버(속성(필드(변수)),기능(메서드)를 정의한 문서 (==설계도)
public class Student {
	...
	// priavte 접근 제한자 -> 외부 직접 접근을 제한(캡슐화 원칙)
	 ...
	 * */
	public Student() {
		System.out.println("--Student 객체 기본생성자에 의해 생성되었습니다--");
	...
	public String getName() { // getName -> return name 으로보내서 무슨자료형인지 void 대신작성
		return name;
	}
	...
	// public void(반환안해) set필드명(매개변수){
	// this.필드명 = 매개변수명; ->  this : student(객체)
	//}
