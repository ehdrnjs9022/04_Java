...
public class Main1 {
	public static void main(String[] args) {
		...
		Calculator calc5 = (a,b) -> (int)Math.pow(a,2) + (int)Math.pow(b, 3);
				...
				System.out.println("calc5.sumTwoNumber(3,4) :"
						 + calc5.sumTwoNumber(3, 4)); 
