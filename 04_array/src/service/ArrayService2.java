...
public class ArrayService2 {
	...
	public void method1() {
		...
		// hashCode() : 주소(저장위치)를 이용해서 만든 해시함수 결과 값
		...
		int[] copyArr2 = new int[arr2.length]; //4로써도됨
		...
		// 해시코드 (주소비슷)가 다름을 확인 -> 서로 다른 배열 참조
		...
		int[] copyArr3 = new int[arr2.length]; //4로써도됨
