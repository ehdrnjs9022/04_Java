...
import section03.dto.JDKCalculator;
import section03.dto.JDKCalculator2;
...
public class InterfaceRun {
	...
	public static void main(String[] args) {
		...
		//Calculator calc = new JDKCalculator();
		
		/* 같은 Calculator 인터페이스를 상속 받은 다른 클래스 객체
		...
		Calculator calc = new JDKCalculator2();
