...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 *   
		 *   int   (4byte, 정수 기본형)
		 *   -> 정수 형태로 작성된 값은 일단 무조건 int 자료형으로 판단
		 *   
		 *   long  (8byte)
		 *   -> 쉿자 뒤에 L 또는 l을 붙임 (L,l의 long 리터럴)
		 *  
		 *  - 실수형 
		 *  float  (4byte)
		 *  -> 숫자 뒤에 F 또는 f를 붙임
		 *  
		 *  dobule (8byte, 실수 기본형)
		 *  -> 실수 형태로 작성된 값 무조건 double 자료형으로 판단		
		 *  
		 *  - 문자형
		 *  
		 ...
		 */
		    ...
		    //변수 선언
		 	int num1; 
		 	// 메모리에 int형 "정수"를 저장할 공간 "4byte"할당하고
		 	...
		 	// sysout + ctrl + sapce -> enter : println() snippet
		 	System.out.println("----------------------------");
		 	...
		 	// -> int 범위 초과한 값은 대입 불가!!
		 	// --> 정수형 중에서 범위가 더 큰 long
		 	// int intNum2 = 2147483648; 
		 	
		 	// 2147483648; <- 일반 정수 표기법 == int로 인식된다
		 	// 2147483648L 또는 2147483648 표기 == long으로 시작된다!		 	  
