...
public class VariableEx3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("[자동 형변환 예제 1 - 데이터 손실]");
		
		int num1 = 290;
		byte result1 = (byte)num1; // byte 강제 형변환
		
		System.out.println("num1 : " + num1);  // 290
		System.out.println("num1 : " + result1); // 34
		
		System.out.println("----------------------------------");
		System.out.println("[자동 형변환 예제 2 - 데이터 손실]");
		...
		System.out.println("num2 :" + result2); // 123
		
		
		System.out.println("----------------------------------");
		System.out.println("[자동 형변환 예제 3 - 데이터 손실 의도적 사용]");
	...
	for(int i=0; i<5 ; i++) {
		...
		System.out.println("A 뒤에 10번째 단어 : " + (char)('A' + 10) ); 
