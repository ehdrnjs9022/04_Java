...
public class SetService {
	...
	//(인터페이스)
		...
		/* String toStirng() : 저장된 값을 문자열로 출력 */
		// -> 순서 유지 X 인
	 ...
	 * 
	 * - hashCode() : 객체의 식별번호
	 *                equlas()가 true이면 hashCode()도 같아야함
	 * 								-> 빠르게 찾기 위해 활용
	 */
	 ...
	 *  [Iterator<E> 인터페이스]
	 *  - 반복자 기능 제공 인터페이스
	 *  - <E>는 반복자가 반환하는 요소의 유형
	 *  
	 *  1) boolean hashNext() : 
	 *  다음 반복 접근할 요소가 있으면 true, 없으면 false (다음 반복할게 있어?)
	 *  
	 *  2) E next() :
	 *  다음 요소를 반환
	 *  -> 무조건 hasNext() 이후에 사용 
	...
	public void test3() {
		...
		// snacks(set)에 저장된 값을 순차접근(반복접근) 하는 객체 반환
	 ...
	 * 
	 * ** 선행 조건 **
	 * 저장되는 객체가 Comparable 인터페이스 상속 받아서 구현
