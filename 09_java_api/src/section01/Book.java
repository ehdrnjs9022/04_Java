...
public class Book {
	...
	public boolean equals(Object obj) {
		...
		// -> 같은 객체 비교하는 시간 낭비 하지말자 (아래 if문전부랑같음)
		...
		//if(!(obj instanceof Book)) return false;  방법1
		if(this.getClass() != obj.getClass()) return false; //방법2
